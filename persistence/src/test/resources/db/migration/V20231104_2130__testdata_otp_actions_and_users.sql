...
VALUES
    ...
    (-500, 'creds_expired_user5.petergabriel@example.com', FALSE, '{noop}petergabriel', TRUE, '1000-01-01 00:00:00.0+00', '3000-01-01 00:00:00.0+00', '1000-01-01 00:00:00.0+00');
...
INSERT INTO otp_actions (action_id, user_id, action, valid_until)
VALUES
    ('facade00-0000-4000-a000-000000000000', -100, 'verify-email', '3000-01-01 00:00:00.0+00'),
    ('decade00-0000-4000-a000-000000000000', -200, 'reset-password', '3000-01-01 00:00:00.0+00');
